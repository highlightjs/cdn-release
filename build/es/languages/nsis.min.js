...
begin:t.concat(t.either("ARCHIVE","FILE_ATTRIBUTE_ARCHIVE","FILE_ATTRIBUTE_NORMAL","FILE_ATTRIBUTE_OFFLINE","FILE_ATTRIBUTE_READONLY","FILE_ATTRIBUTE_SYSTEM","FILE_ATTRIBUTE_TEMPORARY","HKCC","HKCR","HKCR32","HKCR64","HKCU","HKCU32","HKCU64","HKDD","HKEY_CLASSES_ROOT","HKEY_CURRENT_CONFIG","HKEY_CURRENT_USER","HKEY_DYN_DATA","HKEY_LOCAL_MACHINE","HKEY_PERFORMANCE_DATA","HKEY_USERS","HKLM","HKLM32","HKLM64","HKPD","HKU","IDABORT","IDCANCEL","IDIGNORE","IDNO","IDOK","IDRETRY","IDYES","MB_ABORTRETRYIGNORE","MB_DEFBUTTON1","MB_DEFBUTTON2","MB_DEFBUTTON3","MB_DEFBUTTON4","MB_ICONEXCLAMATION","MB_ICONINFORMATION","MB_ICONQUESTION","MB_ICONSTOP","MB_OK","MB_OKCANCEL","MB_RETRYCANCEL","MB_RIGHT","MB_RTLREADING","MB_SETFOREGROUND","MB_TOPMOST","MB_USERICON","MB_YESNO","MB_YESNOCANCEL","OFFLINE","READONLY","SHCTX","SHELL_CONTEXT","SW_HIDE","SW_SHOW","SW_SHOWMAXIMIZED","SW_SHOWMINIMIZED","SW_SHOWNORMAL"),/\b/)
},s={className:"keyword",
begin:t.concat(/!/,t.either("addincludedir","addplugindir","appendfile","appendmemfile","assert","cd","define","delfile","echo","else","elseif","elseifdef","elseifmacrodef","elseifmacrondef","elseifndef","endif","error","execute","finalize","getdllversion","gettlbversion","if","ifdef","ifmacrodef","ifmacrondef","ifndef","include","insertmacro","macro","macroend","macroundef","makensis","packhdr","pragma","searchparse","searchreplace","system","tempfile","undef","uninstfinalize","verbose","warning"),/\b/)
...
},o,s,i,r,a,l,{className:"title.function",begin:/\w+::\w+/},e.C_NUMBER_MODE]}}
