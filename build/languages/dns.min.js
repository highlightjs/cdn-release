...
aliases:["bind","zone"],case_insensitive:!0,
keywords:["A","AAAA","AFSDB","APL","CAA","CDNSKEY","CDS","CERT","CNAME","DHCID","DLV","DNAME","DNSKEY","DS","HIP","IPSECKEY","KEY","KX","LOC","MX","NAPTR","NS","NSEC","NSEC3","NSEC3PARAM","PTR","RRSIG","RP","SIG","SOA","SRV","SSHFP","TA","TKEY","TLSA","TSIG","TXT"],
contains:[d.COMMENT(";","$",{relevance:0}),{
match:[/\bCAA\b/,/[ \t]+/,/\d+/,/[ \t]+/,/\b(?:issuewild|issue|iodef|contactemail|contactphone|issuevmc|issuemail)\b/],
scope:{1:"keyword",3:"number",5:"attr"}},{scope:"string",begin:/"/,end:/"/,
illegal:/\n/,contains:[{scope:"char.escape",match:/\\(?:\d{3}|[^\d\n])/}]},{
match:[/\bTXT\b/,/\s+/,/(?!")(?:\\(?:\d{3}|[^\d\n])|[^\s;"()\\])+/],scope:{
1:"keyword",3:"string"}},{className:"meta",
begin:/^\$(TTL|GENERATE|INCLUDE|ORIGIN)\b/},{scope:"punctuation",match:/[()]/},{
scope:"type",match:/\b(?:IN|CH|HS)\b/},{className:"number",
