...
*/
var hljs=function(){"use strict";var e=function(e,n,t){return function(e){
...
var r=n[t];"object"!=typeof r||Object.isFrozen(r)||e(r)})),n
},e.exports.default=e.exports}(t={path:void 0,exports:{},require:function(e,n){
return function(){
throw Error("Dynamic requires are not currently supported by @rollup/plugin-commonjs")
}(null==n&&t.path)}},t.exports),t.exports}();class n{constructor(e){
void 0===e.data&&(e.data={}),this.data=e.data}ignoreMatch(){this.ignore=!0}}
function t(e){
...
},v=function(e,n,t={}){const s=r({className:"comment",begin:e,end:n,contains:[]
},t);return s.contains.push(E),s.contains.push({className:"doctag",
begin:"(?:TODO|FIXME|NOTE|BUG|OPTIMIZE|HACK|XXX):",relevance:0}),s
},_=v("//","$"),w=v("/\\*","\\*/"),N=v("#","$");var y=Object.freeze({
...
QUOTE_STRING_MODE:x,PHRASAL_WORDS_MODE:E,COMMENT:v,C_LINE_COMMENT_MODE:_,
...
;const R=["of","and","for","in","not","or","if","then","parent","list","value"]
...
const A=t,j=r,{nodeStream:I,mergeStreams:S}=i,T=Symbol("nomatch")
...
function c(){null!=y.subLanguage?function(){if(""===O)return;let e=null
;if("string"==typeof y.subLanguage){
if(!s[y.subLanguage])return void M.addText(O)
;e=p(y.subLanguage,O,!0,R[y.subLanguage]),R[y.subLanguage]=e.top
}else e=m(O,y.subLanguage.length?y.subLanguage:null)
;y.relevance>0&&(L+=e.relevance),M.addSublanguage(e.emitter,e.language)
}():function(){if(!y.keywords)return void M.addText(O);let e=0
;y.keywordPatternRe.lastIndex=0;let n=y.keywordPatternRe.exec(O),t="";for(;n;){
t+=O.substring(e,n.index);const r=l(y,n);if(r){const[e,s]=r
;M.addText(t),t="",L+=s;const i=_.classNameAliases[e]||e;M.addKeyword(n[0],i)
}else t+=n[0];e=y.keywordPatternRe.lastIndex,n=y.keywordPatternRe.exec(O)}
t+=O.substr(e),M.addText(t)}(),O=""}function g(e){
return e.className&&M.openNode(_.classNameAliases[e.className]||e.className),
...
const n=e[0],t=a.substr(e.index),r=h(y,e,t);if(!r)return T;const s=y
;s.skip?O+=n:(s.returnEnd||s.excludeEnd||(O+=n),c(),s.excludeEnd&&(O=n));do{
...
if(O+=a.slice(s.index,s.index+1),!o){const n=Error("0 width match regex")
...
c(),r.returnBegin||r.excludeBegin||(O=t)),g(r),r.returnBegin?0:t.length}(s)
;if("illegal"===s.type&&!r){
const e=Error('Illegal lexeme "'+i+'" for mode "'+(y.className||"<unnamed>")+'"')
;throw e.mode=y,e}if("end"===s.type){const e=b(s);if(e!==T)return e}
if("illegal"===s.type&&""===i)return 1
;if(I>1e5&&I>3*s.index)throw Error("potential infinite loop, way more iterations than matches")
;return O+=i,i.length}const _=v(e);if(!_)throw console.error(u.replace("{}",e)),
Error('Unknown language: "'+e+'"');const w=k(_);let N="",y=i||w
;const R={},M=new d.__emitter(d);!function(){const e=[]
;for(let n=y;n!==_;n=n.parent)n.className&&e.unshift(n.className)
;e.forEach((e=>M.openNode(e)))}();let O="",L=0,j=0,I=0,S=!1;try{
for(y.matcher.considerAll();;){
I++,S?S=!1:y.matcher.considerAll(),y.matcher.lastIndex=j
;const e=y.matcher.exec(a);if(!e)break;const n=E(a.substring(j,e.index),e)
;j=e.index+n}return E(a.substr(j)),M.closeAllNodes(),M.finalize(),N=M.toHTML(),{
relevance:L,value:N,language:e,illegal:!1,emitter:M,top:y}}catch(n){
if(n.message&&n.message.includes("Illegal"))return{illegal:!0,illegalBy:{
msg:n.message,context:a.slice(j-100,j+100),mode:n.mode},sofar:N,relevance:0,
value:A(a),emitter:M};if(o)return{illegal:!1,relevance:0,value:A(a),emitter:M,
...
;return n.emitter.addText(e),n}(e),r=n.filter(v).filter(w).map((n=>p(n,e,!1)))
;r.unshift(t);const i=r.sort(((e,n)=>{
if(e.relevance!==n.relevance)return n.relevance-e.relevance
;if(e.language&&n.language){if(v(e.language).supersetOf===n.language)return 1
;if(v(n.language).supersetOf===e.language)return-1}return 0})),[a,o]=i,l=a
...
n?t[1]:"no-highlight"}return n.split(/\s+/).find((e=>h(e)||v(e)))}(e)
;if(h(t))return;N("before:highlightBlock",{block:e,language:t
}),d.useBR?(n=document.createElement("div"),
n.innerHTML=e.innerHTML.replace(/\n/g,"").replace(/<br[ /]*>/g,"\n")):n=e
;const r=n.textContent,s=t?f(t,r,!0):m(r),a=I(n);if(a.length){
const e=document.createElement("div");e.innerHTML=s.value,s.value=S(a,I(e),r)}
...
;function v(e){return e=(e||"").toLowerCase(),s[e]||s[i[e]]}
function _(e,{languageName:n}){"string"==typeof e&&(e=[e]),e.forEach((e=>{i[e]=n
}))}function w(e){const n=v(e);return n&&!n.disableAutodetect}function N(e,n){
...
return Object.keys(s)},getLanguage:v,registerAliases:_,
requireLanguage:function(e){
console.warn("requireLanguage is deprecated and will be removed entirely in the future."),
console.warn("Please see https://github.com/highlightjs/highlight.js/pull/2844")
;const n=v(e);if(n)return n
...
o=!0},t.versionString="10.4.0-beta1"
...
hljs.registerLanguage("bash",function(){"use strict";function e(...e){
return e.map((e=>{return(s=e)?"string"==typeof s?s:s.source:null;var s
})).join("")}return function(s){const n={},t={begin:/\$\{/,end:/\}/,
...
hljs.registerLanguage("css",function(){"use strict";return function(e){
...
return function(t){const c=e,o={begin:/<[A-Za-z0-9\\._:-]+/,
...
hljs.registerLanguage("perl",function(){"use strict";function e(...e){
return e.map((e=>{return(n=e)?"string"==typeof n?n:n.source:null;var n
})).join("")}return function(n){var t={$pattern:/[\w.]+/,
...
begin:/^\.\.\.(?=[ ]|$)/}]}]}}}());
hljs.registerLanguage("ruby",function(){"use strict";function e(...e){
return e.map((e=>{return(n=e)?"string"==typeof n?n:n.source:null;var n
})).join("")}return function(n){
var a,i="([a-zA-Z_]\\w*[!?=]?|[-+~]@|<<|>>|=~|===?|<=>|[<>]=?|\\*\\*|[-/+%^&*~`|]|\\[\\]=?)",s={
...
}].concat(b,t),relevance:0}].concat(b,t);c.contains=_,o.contains=_;var u=[{
begin:/^\s*=>/,starts:{end:"$",contains:_}},{className:"meta",
begin:"^([>?]>|[\\w#]+\\(\\w+\\):\\d+:\\d+>|(\\w+-)?\\d+\\.\\d+\\.\\d(p\\d+)?[^>]+>)(?=[ ])",
starts:{end:"$",contains:_}}];return t.unshift(b),{name:"Ruby",
aliases:["rb","gemspec","podspec","thor","irb"],keywords:s,illegal:/\/\*/,
contains:[n.SHEBANG({binary:"ruby"})].concat(u).concat(t).concat(_)}}}());
